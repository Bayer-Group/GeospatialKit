...
class PointTests: XCTestCase {
    ...
    func testCoordinate() {
        let resultCoordinate = point.locationCoordinate
        
        AssertEqualAccuracy10(resultCoordinate.latitude, point.latitude)
        AssertEqualAccuracy10(resultCoordinate.longitude, point.longitude)
    }
